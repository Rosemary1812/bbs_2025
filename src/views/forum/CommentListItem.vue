<template>
  <div class="comment-item">
    ...
    <div class="comment-info">
        <div class="nick-name">
            <span name="name" @click="gotuUcenter(sub.userId)">{{ commentData.nickName }}</span>
            <span v-if="commentData.userId==articleUserId" class="tag-auther">作者</span>
        </div>
        ...
        <div class="comment-sub-list" v-if="commentData.children">
            <div class="comment-sub-item" v-for="sub in commentData.children">
                ...
                <div class="comment-sub-info">
                    <div class="nick-name">
                        <span name="name" @click="gotuUcenter(sub.userId)">{{ sub.nickName }}</span>
                        <span v-if="sub.userId==articleUserId" class="tag-auther">作者</span>
                        <span class="reply-name">回复</span>
                        <span @click="gotuUcenter(sub.replyUserId)" class="a-link">@{{ sub.replyNickName }}</span>
                        <span>：</span>    
        ...
        <div class="reply-info" v-if="commentData.showReply">
            ...
            :showInsertImg="false"
            @postCommentFinish="hiddenAllReplyHandler"
...
const haveShow=props.commentData.show==undefined
?false
